...
import net.lavender.peachy.common.block.custom.*;
...
public class BlockInit {
    ...
    public static final RegistryObject<Block> CHEESE_WHEEL = registerBlock("cheese_wheel",
            () -> new CheeseWheelBlock(BlockBehaviour.Properties.copy(Blocks.CAKE).pushReaction(PushReaction.DESTROY).mapColor(MapColor.COLOR_YELLOW)));
    ...
    public static final RegistryObject<Block> LEMON_TART = registerBlock("lemon_tart",
            () -> new LemonTartBlock(BlockBehaviour.Properties.copy(Blocks.CAKE).pushReaction(PushReaction.DESTROY).mapColor(MapColor.COLOR_YELLOW)));
    ...
    public static final RegistryObject<Block> ROASTED_PEACH_PIT_SACK = registerBlock("roasted_peach_pit_sack",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.WHITE_WOOL).sound(SoundType.WOOL).mapColor(MapColor.TERRACOTTA_BROWN)));
    public static RegistryObject<Block> CHANTERELLE_CRATE = registerBlock("chanterelle_crate",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG).mapColor(MapColor.WOOD)));
    public static RegistryObject<Block> CHERRY_CRATE = registerBlock("cherry_crate",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG).mapColor(MapColor.WOOD)));
    public static RegistryObject<Block> FLY_AMANITA_CRATE = registerBlock("fly_amanita_crate",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG).mapColor(MapColor.WOOD)));
    ...
    public static final RegistryObject<Block> OAK_PALISADE = registerBlock("oak_palisade",
            () -> new PalisadeBlock(BlockBehaviour.Properties.copy(Blocks.OAK_LOG).mapColor(MapColor.WOOD)));
    public static final RegistryObject<Block> SPRUCE_PALISADE = registerBlock("spruce_palisade",
            () -> new PalisadeBlock(BlockBehaviour.Properties.copy(Blocks.SPRUCE_LOG).mapColor(MapColor.WOOD)));
    ...
    public static final RegistryObject<Block> POTTED_ROSE = BLOCKS.register("potted_rose",
            () -> new FlowerPotBlock(() -> ((FlowerPotBlock) Blocks.FLOWER_POT), BlockInit.ROSE_FLOWER,
                    BlockBehaviour.Properties.copy(Blocks.POTTED_ALLIUM).noOcclusion()));
    public static final RegistryObject<Block> FLY_AMANITA = registerBlock("fly_amanita",
            () -> new FlowerBlock(MobEffects.POISON, 400, BlockBehaviour.Properties.copy(Blocks.ALLIUM).pushReaction(PushReaction.DESTROY).sound(SoundType.STEM).noCollission().mapColor(MapColor.CRIMSON_HYPHAE)));
    public static final RegistryObject<Block> CHANTERELLE = registerBlock("chanterelle",
            () -> new FlowerBlock(MobEffects.REGENERATION, 800, BlockBehaviour.Properties.copy(Blocks.ALLIUM).pushReaction(PushReaction.DESTROY).sound(SoundType.STEM).noCollission().mapColor(MapColor.TERRACOTTA_ORANGE)));



    public static RegistryObject<Block> PROTOTAXITES_FOSSIL_BLOCK= registerBlock("prototaxites_fossil",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.DIAMOND_ORE).sound(SoundType.STONE).mapColor(MapColor.STONE)));
