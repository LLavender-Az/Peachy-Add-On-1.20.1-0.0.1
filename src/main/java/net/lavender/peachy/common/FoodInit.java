...
public class FoodInit {
    ...
    public static class Foods {
        ...
        public static final FoodProperties CHEESE = new FoodProperties.Builder().nutrition(5).saturationMod(5f).effect(() ->
                new MobEffectInstance(ModEffects.RADIANT.get(), 600, 0), 1.0f).build();
        ...
        public static final FoodProperties FRUIT_PUNCH = new FoodProperties.Builder().nutrition(8).saturationMod(8f).effect(() ->
                new MobEffectInstance(ModEffects.RADIANT.get(), 3000, 0), 1.0f).build();
        ...
        public static final FoodProperties LEMONADE = new FoodProperties.Builder().nutrition(5).saturationMod(4.5f).effect(() ->
                new MobEffectInstance(ModEffects.RADIANT.get(), 3000, 0), 1.0f).build();
