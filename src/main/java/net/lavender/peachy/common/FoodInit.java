...
public class FoodInit {
    ...
    public static final RegistryObject<Item> CHERRY = FOODS.register("cheese", () -> new Item(props().food(Foods.CHERRY)));
    ...
    public static final RegistryObject<Item> LEMON_TART = FOODS.register("lemon_tart", () -> new StrongEffectRadiantSnack(props().food(Foods.LEMON_TART)));
    ...
    public static class Foods {
        ...
        public static final FoodProperties BEEF_JERKY = new FoodProperties.Builder().nutrition(8).saturationMod(8f).effect(() -> new MobEffectInstance(ModEffects.RADIANT.get(), 600, 0), 1.0f).build();
        ...
        public static final FoodProperties CHEESE_N_FRUITS = new FoodProperties.Builder().nutrition(7).saturationMod(8.5f).effect(() -> new MobEffectInstance(ModEffects.RADIANT.get(), 3000, 0), 1.0f).build();
        public static final FoodProperties CHEESE_WEDGE = new FoodProperties.Builder().nutrition(5).saturationMod(5f).build();
        public static final FoodProperties CHERRY = new FoodProperties.Builder().nutrition(4).saturationMod(2.4f).effect(() -> new MobEffectInstance(MobEffects.REGENERATION, 200, 0), 0.8f).build();
        ...
        public static final FoodProperties GLOWBERRY_JUICE = new FoodProperties.Builder().nutrition(3).alwaysEat().saturationMod(4.5f).effect(() -> new MobEffectInstance(MobEffects.GLOWING, 600, 0), 1.0f).effect(() -> new MobEffectInstance(MobEffects.NIGHT_VISION, 600, 0), 1.0f).build();
        ...
        public static final FoodProperties HONEY_MINT_TEA = new FoodProperties.Builder().nutrition(4).alwaysEat().saturationMod(4.5f).effect(() -> new MobEffectInstance(ModEffects.RADIANT.get(), 600, 0), 1.0f).effect(() -> new MobEffectInstance(ModEffects.STIMULATED.get(), 600, 0), 1.0f).build();
        public static final FoodProperties LEMON = new FoodProperties.Builder().nutrition(4).saturationMod(2.4f).effect(() -> new MobEffectInstance(MobEffects.REGENERATION, 200, 0), 0.8f).build();
        public static final FoodProperties LEMONADE = new FoodProperties.Builder().nutrition(3).alwaysEat().saturationMod(4.5f).effect(() -> new MobEffectInstance(ModEffects.RADIANT.get(), 3000, 0), 1.0f).build();
        public static final FoodProperties LEMON_BAR = new FoodProperties.Builder().nutrition(5).saturationMod(3.2f).build();
        ...
        public static final FoodProperties LEMON_POP = new FoodProperties.Builder().nutrition(5).alwaysEat().saturationMod(4f).effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 1200, 0), 1.0f).effect(() -> new MobEffectInstance(MobEffects.DIG_SPEED, 1200, 0), 1.0f).build();
        public static final FoodProperties LEMON_SLICE = new FoodProperties.Builder().nutrition(1).saturationMod(0.8f).build();
        public static final FoodProperties LEMON_TART = new FoodProperties.Builder().nutrition(7).saturationMod(6.8f).effect(() -> new MobEffectInstance(ModEffects.RADIANT.get(), 6000, 0), 1.0f).build();
        public static final FoodProperties LEMON_TEA = new FoodProperties.Builder().nutrition(4).alwaysEat().saturationMod(3.5f).effect(() -> new MobEffectInstance(ModEffects.RADIANT.get(), 3000, 0), 1.0f).build();
        public static final FoodProperties MAC_N_CHEESE = new FoodProperties.Builder().nutrition(8).saturationMod(8f).effect(() -> new MobEffectInstance(ModEffects.RADIANT.get(), 6000, 0), 1.0f).build();
        ...
        public static final FoodProperties PEACH_JUICE = new FoodProperties.Builder().nutrition(3).alwaysEat().saturationMod(4.5f).effect(() -> new MobEffectInstance(ModEffects.RADIANT.get(), 3000, 0), 1.0f).build();
        ...
        public static final FoodProperties PEACH_SODA = new FoodProperties.Builder().nutrition(5).alwaysEat().saturationMod(4f).effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 1200, 0), 1.0f).effect(() -> new MobEffectInstance(MobEffects.DIG_SPEED, 1200, 0), 1.0f).build();
        public static final FoodProperties PEACH_TEA = new FoodProperties.Builder().nutrition(4).alwaysEat().saturationMod(3.5f).effect(() -> new MobEffectInstance(ModEffects.RADIANT.get(), 3000, 0), 1.0f).build();
        ...
        public static final FoodProperties ROSE_TEA = new FoodProperties.Builder().nutrition(4).alwaysEat().saturationMod(3.5f).effect(() -> new MobEffectInstance(ModEffects.RADIANT.get(), 3000, 0), 1.0f).build();
        public static final FoodProperties SWEET_BERRY_JUICE = new FoodProperties.Builder().nutrition(3).alwaysEat().saturationMod(4.5f).effect(() -> new MobEffectInstance(ModEffects.RADIANT.get(), 3000, 0), 1.0f).build();
